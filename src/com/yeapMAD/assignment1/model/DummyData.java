...
public class DummyData
{
	...
	{
		collection.add(new PlannedEvent("Ghandi's Barmitsvah", "Bring a cap!", new GregorianCalendar(2014, 10, 14)));
		collection.add(new PlannedEvent("The Rapture", "Get lootin!", new GregorianCalendar(2014, 11, 9)));
		collection.add(new PlannedEvent("The Rapture again", "It didn't actually happen the first time", new GregorianCalendar(2014, 8, 19)));
